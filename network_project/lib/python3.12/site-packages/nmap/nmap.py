...
class PortScanner(object):
    ...
    def scan(  # NOQA: CFQ001, C901
        ...
        if timeout == 0:
            ...
            try:
                ...
                p.kill()
                raise PortScannerTimeout("Timeout from nmap process") from None
    ...
    def analyse_nmap_xml_scan(  # NOQA: CFQ001, C901
        ...
        try:
            ...
            if len(nmap_err) > 0:
                raise PortScannerError(nmap_err) from None
            else:
                raise PortScannerError(self._nmap_last_output) from None
